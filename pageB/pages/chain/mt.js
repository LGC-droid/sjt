...
Page({
  data: {
    ...
    takeaway_platform: 1, //平台选择（1：美团 2：饿了么）
    mask1Hidden: true,
  ...
  onLoad: function (options) {
    ...
    template.tabbar("tabBar", 0, this, options.chain_id, options.title) 
  },
  getLocation() {
    var that = this
    wx.getLocation({
  ...
  onShareAppMessage: function () {
    ...
    return {
      ...
      title: "外卖返现，就上叮叮饭粒",
      path: '/pageB/pages/chain/mt?spid=' + app.globalData.uid + '&chain_id=' + this.data.chain_id + '&title=' + this.data.title,
    };
  },
  handleChangeScroll({
    detail
